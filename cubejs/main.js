...
function onMouseDown( event_info ) {
	...
	if( (vector.z > 0) && (intersectsBtn.length ) ) {
		window.open("http://neth3d.com/","_self");
	}
	...
	intersectsBtn = ray.intersectObject(Btn4);
	vector.setFromMatrixPosition( Btn4.matrixWorld );
	if( (vector.z > 0) && (intersectsBtn.length ) ) {
		window.open("http://neth3d.com/","_self");
	}

	intersectsBtn = ray.intersectObject(Btn5);
	vector.setFromMatrixPosition( Btn5.matrixWorld );
	if( (vector.z > 0) && (intersectsBtn.length ) ) {
		window.open("http://neth3d.com/","_self");
	}

	intersectsBtn = ray.intersectObject(Btn6);
	vector.setFromMatrixPosition( Btn6.matrixWorld );
	if( (vector.z > 0) && (intersectsBtn.length ) ) {
		window.open("http://neth3d.com/","_self");
	}
